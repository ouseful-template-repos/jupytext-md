...
If you mark code cells with `{"active": "ipynb"}` metadata (from a notebook menu, `View -> Cell Toolbar -> Edit Metadata`), then those code cells will be commented out in the saved `py` file.
